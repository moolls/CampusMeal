...
<div class="container">
       <div class="meal-wrapper">
        <div class="meal-search">
            <h2 class="title">Filter by out delicious recipes posted by our own users! </h2>
...
<div>
<form class="deleteForm" method="POST" action="admin-posts.php">
            <label for="delete">Enter the postId for the post you want to delete</label><br>
            <input type="text" name="idNum" id="idNum" placeholder="Enter postId">
            <button type="submit" name="deleteButton" class="deleteButton" id="deleteButton">Delete posts</button>
...
if ($result) {
    while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
        ...
        echo '<div class="delete-form"><b>PostId:</b> '  . $row["id"] . "</div>";
        echo'<div class="post-item"';  
        echo'<div class="post-title">';
